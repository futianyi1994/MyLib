 ...
 */
public class NestedScrollableForVp2 extends FrameLayout {
    private int touchSlop;
    private float initialX;
    private float initialY;
    private HashMap _$_findViewCache;

    public NestedScrollableForVp2(Context context) {
        super(context);
        ViewConfiguration var10001 = ViewConfiguration.get(this.getContext());
        this.touchSlop = var10001.getScaledTouchSlop();
    }

    public NestedScrollableForVp2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ViewConfiguration var10001 = ViewConfiguration.get(this.getContext());
        this.touchSlop = var10001.getScaledTouchSlop();
    }
